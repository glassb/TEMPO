...
Townhouses = [[1,1,1,None,None],[1,2,2,None,None],[1,2,3,None,None],[1,2,4,None,None],[2,1,5,None,None], [2,2,6,None,None],[2,3,7,None,None],[2,4,8,None,None],[3,1,9,None,None],[3,2,10,None,None],[3,3,11,None,None],[3,4,12,None,None]]
...
row = cursor.fetchone()
print("Aggregate Average kW consumption (All 12 Suites since 07-01-2018): %s" % (round(row[0],2)))
print("\n\n\n\n")
...
for i in Townhouses:
	print("		[Townhouse %s %s] 			Current kW: %s  		7-day Average kW: %s \n" % (i[0],i[1],i[3],round(i[4],2)))
